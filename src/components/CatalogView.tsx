  ...
  return (
    <div id="catalog-view-root">
      ...
      <div className="relative w-full overflow-hidden bg-slate-950 text-white border-t border-slate-800 pt-8 md:pt-12 pb-16 md:pb-24">
        {/* Subtle left-side text protection gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/85 via-slate-950/40 to-slate-950/10 pointer-events-none z-0"></div>
        
        {/* Banner Background Video - Bright & Normal Clarity */}
        ...
        <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-slate-50 via-slate-50/20 to-transparent pointer-events-none z-5"></div>
